...
func TestNewSession_CreatesWorkspaceDir(t *testing.T) {
	...
	err := svc.NewSession(context.Background(), domain.ChatRef{ChannelKind: "test", ChatID: "42"}, workspace)
...
func TestNewSession_RejectsFileAsWorkspace(t *testing.T) {
	...
	err := svc.NewSession(context.Background(), domain.ChatRef{ChannelKind: "test", ChatID: "42"}, filePath)
	require.Error(t, err)
